...
abstract class $CountryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, String? code, String? flagUrl});
}
...
class _$CountryModelImpl extends _CountryModel {
  ...
  @override
  String toString() {
    return 'CountryModel(id: $id, name: $name, code: $code, flagUrl: $flagUrl)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, code, flagUrl);
